  ...
  <el-container style="height: 100vh;">
    <el-aside width="200px" style="background-color: rgb(238, 241, 246)">
      <el-menu router :default-active="$route.path" unique-opened>
        <el-header style="padding-right: 15px; font-size: 18px; font-weight: bold">迅捷后台管理系统</el-header>
        <el-submenu index="1">
          <template slot="title"><i class="el-icon-s-home"></i>首页</template>
        </el-submenu>
        <el-submenu index="2">
          <template slot="title"><i class="el-icon-s-shop"></i>店铺管理</template>
          <el-menu-item-group>
          ...
          <el-menu-item-group>
            ...
            <el-menu-item index="/shops/create">添加店铺</el-menu-item>
            <el-menu-item index="/shops/list">店铺列表</el-menu-item>
          </el-menu-item-group>
          <el-menu-item-group>
